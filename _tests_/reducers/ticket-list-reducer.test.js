...
describe('ticketListReducer', () => {
  ...
  test('Should return default state if no action type is recgonized', () => {
    expect(ticketListReducer({}, { type: null })).toEqual({});
  });

  test('Should successfully add ticket data to masterTicketList', () => {
  ...
  test('Should pass freshly-calculated Moment-formatted wait time to ticket entry', () => {
    const { names, location, issue, timeOpen, id } = sampleTicketData;
    action = {
      type: 'UPDATE_TIME',
